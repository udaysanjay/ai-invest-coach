...
serve(async (req) => {
  ...
  try {
    ...
    const context = financialData ? 
      ...
      Please provide personalized financial advice based on this information. Focus on investment strategies suitable for their income level and savings capacity. All amounts should be in Indian Rupees (₹).` 
      : 'Provide general financial and investment advice.'
